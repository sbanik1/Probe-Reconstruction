...
%% Inputs==================================================================
% Basic Inputs ============================================================
RunNo_plot = [326, 345, 367];   % Image run number to reconstruct
RunNo_GSbasis = 31:200;         % Image run number for GS basis
dateFile = '2020_11_24';        % Date folder
PrRe = 'None';                    % Type of Probe Reconst. [Choose from 'None', 'PCA' or 'GS']
